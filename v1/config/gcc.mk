...
CFG_DEFS := $(CFG_DEFS) -DOEX_PROJECT_NAME="\"$(CFG_NAME)\"" -DOEX_PROJECT_LNAME="\"$(CFG_LNAME)\"" -DOEX_PROJECT_DESC="\"$(CFG_DESC)\"" $(CFG_VER_DEF)
ifdef SQENGINE
	CFG_DEFS := $(CFG_DEFS) -DOEX_SQENGINE="\"$(SQENGINE)\""
endif	


CFG_LOCAL_TOOL_JOIN  	:= $(CFG_LOCAL_BUILD_TYPE)/join$(CFG_BLD_POST)

ifdef PRJ_SQEX
	CFG_LOCAL_TOOL_RESCMP  	:= "$(CFG_LOCAL_BUILD_TYPE)/sqrbld$(CFG_BLD_POST)"
else
	CFG_LOCAL_TOOL_RESCMP 	:= $(CFG_LOCAL_BUILD_TYPE)/resbld$(CFG_BLD_POST)
endif
