//
// ZoneMinder Configuration, $Date: 2011-06-21 05:19:10 -0400 (Tue, 21 Jun 2011) $, $Revision: 3459 $
...
#define ZM_CONFIG				"~/.zoneminder"	// Path to config file
#define ZM_VERSION				"0.0.0.0"		// ZoneMinder Version
