...
unsigned int _Cdecl _clearfp(void);
unsigned int _Cdecl _controlfp(unsigned int _new, unsigned int mask);
void _Cdecl _fpreset(void);
unsigned int _Cdecl _statusfp(void);
